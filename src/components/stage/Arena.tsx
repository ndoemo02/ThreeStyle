...
export function Arena() {
    ...
    const brickMap = useTexture('/textures/stage/brick-color.jpg')
    const brickRoughness = useTexture('/textures/stage/brick-rough.jpg')
    const brickNormal = useTexture('/textures/stage/brick-normal.jpg')
