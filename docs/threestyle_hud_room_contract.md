...
* Profil minimalny:
  ...
  * display\_name,
  * creator\_name,
  * avatar\_url opcjonalnie,
  * creator\_slug opcjonalnie.
...
Ekran nie jest formularzem uploadu.   # Bramka rzucająca obraz z kamery użytkownika na ekran/ zostaje do rozstrzygnięcia
